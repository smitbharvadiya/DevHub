...
export default function AISummaryBox({ summary, loadingStatus }) {
    ...
    return (
        <>
            {loadingStatus ? (
                <div className="flex justify-center items-center max-h-[300px] w-full bg-gradient-to-br from-white via-gray-50 to-gray-100 animate-fadeIn backdrop-blur-sm rounded-xl shadow-md mx-3 my-3 p-6">
